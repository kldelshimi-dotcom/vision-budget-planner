...
export const CATEGORIES: Category[] = [
  ...
  { name: "Capelli", group: "Necessità", budget: 20, color: "#818CF8" },
  { name: "Beauty", group: "Varie", budget: 32, color: "#F472B6" },
  { name: "Sport", group: "Varie", budget: 92, color: "#FB7185" },
  { name: "Lavaggio auto", group: "Varie", budget: 40, color: "#FBBF24" },
  { name: "Uscite", group: "Varie", budget: 329.5, color: "#F59E0B" },
